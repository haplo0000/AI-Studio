...
try {
  contextBridge.exposeInMainWorld('aiStudio', {
    ...
    setCurrentWorkshop: (workshopId) =>
      ipcRenderer.invoke('studio:set-current-workshop', workshopId),
    openWorkshopFolder: (workshopId) =>
      ipcRenderer.invoke('studio:open-workshop-folder', workshopId),
    openWorkshopInCursor: (workshopId) =>
      ipcRenderer.invoke('studio:open-workshop-cursor', workshopId),
    ...
    blacksmithSendToCouncil: (sessionId) =>
      ipcRenderer.invoke('blacksmith:send-to-council', sessionId),
    ...
    imageStudioOpenFolder: (folderPath) =>
      ipcRenderer.invoke('image-studio:open-folder', folderPath),
